...
setup(
    ...
    ('Official CLI for Wildebeest for N3NCLOUD, accessible using a command line tool implemented in Python 3.\n\n'
     'wildebeest is a CKAN-based solution for building data portals that share public data by DCAT standards.'
     'wildebeest provides the most efficient disclosure of registered datasets and standard protocols for sharing data '
     'with other data catalog systems. wildebeest uses the most compatible standard format and is the best solution '
     'for global data sharing. You can get more information on the Wildebeest Documents('
     'http://d3.n3ncloud.co.kr/wildebeest/1.0) and N3NCLOUD(https://www.n3ncloud.co.kr/).'),
    author='N3NCLOUD',
